...
public sealed class PathNode(public val isCurve: Boolean = false, public val isQuad: Boolean = false) {

  public abstract fun asFunctionCall(): String

  public object Close : PathNode() {
    override fun asFunctionCall(): String = "close()"
  }

  public data class RelativeMoveTo(val x: Float, val y: Float) : PathNode() {
    override fun asFunctionCall(): String = "moveToRelative(${x}f, ${y}f)"
  }

  public data class MoveTo(val x: Float, val y: Float) : PathNode() {
    override fun asFunctionCall(): String = "moveTo(${x}f, ${y}f)"
  }

  public data class RelativeLineTo(val x: Float, val y: Float) : PathNode() {
    override fun asFunctionCall(): String = "lineToRelative(${x}f, ${y}f)"
  }

  public data class LineTo(val x: Float, val y: Float) : PathNode() {
    override fun asFunctionCall(): String = "lineTo(${x}f, ${y}f)"
  }

  public data class RelativeHorizontalTo(val x: Float) : PathNode() {
    override fun asFunctionCall(): String = "horizontalLineToRelative(${x}f)"
  }

  public data class HorizontalTo(val x: Float) : PathNode() {
    override fun asFunctionCall(): String = "horizontalLineTo(${x}f)"
  }

  public data class RelativeVerticalTo(val y: Float) : PathNode() {
    override fun asFunctionCall(): String = "verticalLineToRelative(${y}f)"
  }

  public data class VerticalTo(val y: Float) : PathNode() {
    override fun asFunctionCall(): String = "verticalLineTo(${y}f)"
  }
  ...
  public data class RelativeCurveTo(
    ...
    override fun asFunctionCall(): String = "curveToRelative(${dx1}f, ${dy1}f, ${dx2}f, ${dy2}f, ${dx3}f, ${dy3}f)"
  }
  ...
  public data class CurveTo(
    ...
    override fun asFunctionCall(): String = "curveTo(${x1}f, ${y1}f, ${x2}f, ${y2}f, ${x3}f, ${y3}f)"
  }
  ...
  public data class RelativeReflectiveCurveTo(
    ...
    override fun asFunctionCall(): String = "reflectiveCurveToRelative(${x1}f, ${y1}f, ${x2}f, ${y2}f)"
  }
  ...
  public data class ReflectiveCurveTo(
    ...
    override fun asFunctionCall(): String = "reflectiveCurveTo(${x1}f, ${y1}f, ${x2}f, ${y2}f)"
  }
  ...
  public data class RelativeQuadTo(
    ...
    override fun asFunctionCall(): String = "quadToRelative(${x1}f, ${y1}f, ${x2}f, ${y2}f)"
  }
  ...
  public data class QuadTo(
    ...
    override fun asFunctionCall(): String = "quadTo(${x1}f, ${y1}f, ${x2}f, ${y2}f)"
  }

  public data class RelativeReflectiveQuadTo(
    val x: Float,
    val y: Float
  ) : PathNode(isQuad = true) {
    override fun asFunctionCall(): String = "reflectiveQuadToRelative(${x}f, ${y}f)"
  }

  public data class ReflectiveQuadTo(
    val x: Float,
    val y: Float
  ) : PathNode(isQuad = true) {
    override fun asFunctionCall(): String = "reflectiveQuadTo(${x}f, ${y}f)"
  }
  ...
  public data class RelativeArcTo(
    ...
    override fun asFunctionCall(): String =
...
private inline fun pathNodesFromArgs(
  ...
  return (0..args.size - numArgs step numArgs).map { index ->
    ...
    when (val node = nodeFor(subArray)) {
      is PathNode.MoveTo if index > 0 -> PathNode.LineTo(
        subArray[0],
        subArray[1]
      )

      is PathNode.RelativeMoveTo if index > 0 ->
        PathNode.RelativeLineTo(
          subArray[0],
          subArray[1]
        )
